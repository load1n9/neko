...
WebGPU renderer for Neko based on
...
```typescript
import { GPUWorld } from "https://deno.land/x/neko/webgpu/mod.ts";
import { createBufferInit } from "https://deno.land/x/neko/webgpu/utils.ts";
import type { Dimensions } from "https://deno.land/x/neko/webgpu/types.ts";
...
<img src="https://github.com/denoland/webgpu-examples/blob/main/boids/output.gif?raw=true" width="1500rem" />
